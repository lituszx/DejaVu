...
public class PlayerPrefsX
{
    ...
    enum ArrayType { Float, Int32, Bool, String, Vector2, Vector3, Quaternion, Color, Texture2D }
    ...
    {
        bool[] convertList = boolList.ToArray();
        return SetBoolArray(key, convertList);
    }
    public static List<bool> GetBoolList(String key)
    {
        List<bool> convertArray = new List<bool>(GetBoolArray(key));
        return convertArray;
    }
    public static List<bool> GetBoolList(String key, bool defaultValue, int defaultSize)
    {
        List<bool> convertArray = new List<bool>(GetBoolArray(key, defaultValue, defaultSize));
        return convertArray;
    }
    ...
    {
        string[] convertList = stringList.ToArray();
        return SetStringArray(key, convertList);
    }
    public static List<String> GetStringList(String key)
    {
        List<String> convertArray = new List<string>(GetStringArray(key));
        return convertArray;
    }
    public static List<String> GetStringList(String key, String defaultValue, int defaultSize)
    {
        List<String> convertArray = new List<string>(GetStringArray(key, defaultValue, defaultSize));
        return convertArray;
    }
    ...
    {
        int[] convertList = intList.ToArray();
        return SetIntArray(key, convertList);
    }
    public static List<int> GetIntList(String key)
    {
        List<int> convertList = new List<int>(GetIntArray(key));
        return convertList;
    }
    public static List<int> GetIntList(String key, int defaultValue, int defaultSize)
    {
        List<int> convertList = new List<int>(GetIntArray(key, defaultValue, defaultSize));
        return convertList;
    }
    ...
    public static bool SetFloatList(String key, List<float> floatList)
    {
        float[] convertList = floatList.ToArray();
        return SetFloatArray(key, convertList);
    }
    public static List<float> GetFloatList(String key)
    {
        List<float> convertList = new List<float>(GetFloatArray(key));
        return convertList;
    }
    public static List<float> GetFloatList(String key, float defaultValue, int defaultSize)
    {
        List<float> convertList = new List<float>(GetFloatArray(key, defaultValue, defaultSize));
        return convertList;
    }
    ...
    public static bool SetVector2List(String key, List<Vector2> vector2List)
    {
        Vector2[] convertList = vector2List.ToArray();
        return SetVector2Array(key, convertList);
    }
    public static List<Vector2> GetVector2List(String key)
    {
        List<Vector2> convertList = new List<Vector2>(GetVector2Array(key));
        return convertList;
    }
    public static List<Vector2> GetVector2List(String key, Vector2 defaultValue, int defaultSize)
    {
        List<Vector2> convertList = new List<Vector2>(GetVector2Array(key, defaultValue, defaultSize));
        return convertList;
    }
    ...
    public static bool SetVector3List(String key, List<Vector3> vector3List)
    {
        Vector3[] convertList = vector3List.ToArray();
        return SetVector3Array(key, convertList);
    }
    public static List<Vector3> GetVector3List(String key)
    {
        List<Vector3> convertList = new List<Vector3>(GetVector3Array(key));
        return convertList;
    }
    public static List<Vector3> GetVector2List(String key, Vector3 defaultValue, int defaultSize)
    {
        List<Vector3> convertList = new List<Vector3>(GetVector3Array(key, defaultValue, defaultSize));
        return convertList;
    }
    ...
    public static bool SetQuaternionList(String key, List<Quaternion> quaternionList)
    {
        Quaternion[] convertList = quaternionList.ToArray();
        return SetQuaternionArray(key, convertList);
    }
    public static List<Quaternion> GetQuaternionList(String key)
    {
        List<Quaternion> convertList = new List<Quaternion>(GetQuaternionArray(key));
        return convertList;
    }
    public static List<Quaternion> GetQuaternionList(String key, Quaternion defaultValue, int defaultSize)
    {
        List<Quaternion> convertList = new List<Quaternion>(GetQuaternionArray(key, defaultValue, defaultSize));
        return convertList;
    }
    ...
    public static bool SetColorList(String key, List<Color> colorList)
    {
        Color[] convertList = colorList.ToArray();
        return SetColorArray(key, convertList);
    }
    public static List<Color> GetColorList(String key)
    {
        List<Color> convertList = new List<Color>(GetColorArray(key));
        return convertList;
    }
    public static List<Color> GetColorList(String key, Color defaultValue, int defaultSize)
    {
        List<Color> convertList = new List<Color>(GetColorArray(key, defaultValue, defaultSize));
        return convertList;
    }
    ...
    public static void SetTexture2D(String key, Texture2D texture)
    {
        SaveBytes(key, Convert_Image2Byte(texture));
    }
    public static Texture2D GetTexture2D(String key)
    {
        return Convert_Byte2Image(LoadBytes(key));
    }
    public static byte[] Convert_Image2Byte(Texture2D img)
    {
        byte[] texByte = img.EncodeToPNG();
        return texByte;
    }
    public static Texture2D Convert_Byte2Image(byte[] imgText)
    {
        Texture2D tex = new Texture2D(2, 2);

        if (tex.LoadImage(imgText))
        {
            return tex;
        }
        return null;
